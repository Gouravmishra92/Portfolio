          ...
          >
            {NAV_LINKS.map((l) => (
              <a
                ...
                onMouseEnter={(e) => {
                  e.target.style.color = "#e879f9";
                  e.target.style.background = "rgba(232,121,249,0.1)";
                }}
                onMouseLeave={(e) => {
                  e.target.style.color = tk.muted(dark);
            ...
            <a
              href="/Gourav_Mishra_Resume2.pdf"
              target="_blank"
              rel="noreferrer"
              style={{
                fontFamily: "Outfit",
        ...
        {open && (
          <div
            style={{
              ...
              borderTop: `1px solid ${tk.border(dark)}`,
              display: "flex",
            ...
            {NAV_LINKS.map((l) => (
              <a
                ...
                style={{
                  ...
                  textDecoration: "none",
                  padding: "12px 0",
                  borderBottom: `1px solid ${tk.border(dark)}`,
                  transition: "color 0.3s",
                }}
              >
                {l.label}
